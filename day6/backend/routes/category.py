...
from flask_security import roles_accepted, current_user, auth_token_required
...
class CategorySpecific(Resource):
    ...
    def put(self, id):
        ...
        # while not var2.ready():
            # pass
        # return jsonify({"message": "update specific category", 'status': var2.status})
